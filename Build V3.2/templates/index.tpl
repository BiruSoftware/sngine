...
<div class="container">
	<div class="row footer {if $page == 'index' && !$user->_logged_in}border-top-0{/if}">
		<div class="col-sm-6">
			...
			<!-- language -->
			<a href="#" data-toggle="dropdown" class="language-dropdown">
                <img width="16" height="16" class="mr10" src="{$system['language']['flag']}">{$system['language']['title']}
            </a>
